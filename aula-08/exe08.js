...
// 2)	Modifique a função podeSubir(), de modo que ela exiba uma mensagem de autorização ou de impedimento no acesso ao brinquedo dependendo
//       se a pessoa se enquadra ou não nas condições do exercício anterior.Por exemplo:
